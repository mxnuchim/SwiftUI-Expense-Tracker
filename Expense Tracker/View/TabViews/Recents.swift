                ...
                ScrollView(.vertical){
                    LazyVStack(spacing: 10, pinnedViews: [.sectionHeaders]) {
                        Section{
                            ...
                            ForEach(sampleTransactions.filter({$0.category == selectedCategory.rawValue})) {transactiton in
                                TransactionCardView(transaction: transactiton)
                            }
                        } header: {
                            HeaderView(size)
                        }
